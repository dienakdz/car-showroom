...
class ShowroomSettingsService
{
    ...
    public function update(array $validated): void
    {
        DB::transaction(function () use ($validated): void {
            ...
            $showroom->fill([
                'name' => (string) $validated['showroom_name'],
                'phone' => (string) $validated['showroom_phone'],
            ...
            $settings = [
                'site.brand_name' => ['value' => (string) $validated['brand_name']],
                'site.default_currency' => ['value' => (string) $validated['default_currency']],
